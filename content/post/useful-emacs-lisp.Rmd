...
what I have here,[^1] so with that in mind I will focus more on the motivations,
thought processes, and progressions I've gone through with these functions. I
also discuss some future directions and how these functions could be improved.
...
find this more effective than Googling solutions.[^2]
...
`file-string`[^3] and (b) opening this string (which is an .html
...
[^1]: Please do share if you have better solutions!
[^2]: Which is baffling.
[^3]: Using `let` would probably be a better approach than `setq`.
[^4]: A Spacemacs requirement?
