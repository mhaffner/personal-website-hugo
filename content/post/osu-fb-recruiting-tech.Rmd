...
summary : "Web scraping, text processing, mapping, and statistical analysis"
math : false
comments : true
---
...
I hope this will serve to help others facing similar issues. These scripts are
also available in full in a [repository on GitLab](https://gitlab.com/mhaffner/okstate-fb-recruiting).
...
knitr::include_graphics("/home/matt/git-repos/okstate-fb-recruiting/img/summary.png")
```
